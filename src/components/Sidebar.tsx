...
const Sidebar = ({ onToggle, activePath = '/' }: SidebarProps) => {
  ...
  const menuItems = [
    ...
    { icon: Swords, label: '美剧', href: '/douban?type=tv&tag=美剧&title=美剧' },
    {
      icon: MessageCircleHeart,
      label: '韩剧',
      href: '/douban?type=tv&tag=韩剧&title=韩剧',
    },
    { icon: MountainSnow, label: '日剧', href: '/douban?type=tv&tag=日剧&title=日剧' },
    { icon: VenetianMask, label: '日漫', href: '/douban?type=tv&tag=日本动画&title=日漫' },
  ];
